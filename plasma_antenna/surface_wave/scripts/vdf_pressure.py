...
DIR="/home/rinku/XOOPIC/xoopic/Antenna/den_1e16"
PRESS = 0.01
DATA = "Electron"
# numerical data file
...
range1 = np.array([0.09,0.14,0.21])
range2 = np.array([ 0.13,0.20,0.26])
...
sns.distplot(data_loc1[:], hist=True, kde=True, color = 'darkblue',
...
sns.distplot(data_loc2[:], hist=True, kde=True, color = 'red',
             hist_kws={'edgecolor':'black'},
             kde_kws={'shade': True, 'linewidth': 2},ax=ax2)
ax3.set_xlabel('A.U.')
ax3.set_ylabel('u_x (m/s)')
#ax2.set_xlim(-10,50)
ax2.legend(['Location: %1.2f'%range1[1]+'-%1.2f'%range2[1]])

sns.distplot(data_loc3[:], hist=True, kde=True, color = 'green',
             hist_kws={'edgecolor':'black'},
...
sns.distplot(data_loc3[:], hist=False, kde=True, color = 'green',
             ...
             kde_kws={'shade': True, 'linewidth': 2},ax=ax1)
ax1.grid(True)
ax1.set_xlabel('u_x (m/s)',fontsize=15)
#ax1.set_xlim(-10,50)
ax1.set_ylabel('Probability density function',fontsize=15)
plt.xticks(fontsize=12)
plt.yticks(fontsize=12) 

#ax1.set_title(DATA+' Energy Distribution Function('+funcName+') \n for pressure = 0.01 Torr',fontsize =15)
ax1.legend(['Location: %1.2f'%range1[0]+'-%1.2f'%range2[0],'Location: %1.2f'%range1[1]+'-%1.2f'%range2[1],'Location: %1.2f'%range1[2]+'-%1.2f'%range2[2]],fontsize=12)
