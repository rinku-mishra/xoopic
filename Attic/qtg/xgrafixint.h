...
int             Color[MAXCOLORS];
float           RedColor[MAXCOLORS];
float           GreenColor[MAXCOLORS];
float           BlueColor[MAXCOLORS];
...
void            XGMainLoop();
/*
int 		C_UpdateCrosshairProc _ANSI_ARGS_ ((ClientData, Tcl_Interp *, 
		int, const char **));
int 		C_SetCrosshairParametersProc _ANSI_ARGS_ ((ClientData,
