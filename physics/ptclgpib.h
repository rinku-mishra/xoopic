...
class ParticleGroupIBES : public ParticleGroup
{
public:
	ParticleGroupIBES(int maxN, Species* s, Scalar np2c0, BOOL vary_np2c = FALSE)
		: ParticleGroup(maxN, s, np2c0, vary_np2c) {}
	void advance(Fields& fields, Scalar dt);
};

class ParticleGroupIBEM : public ParticleGroup
{
public:
	ParticleGroupIBEM(int maxN, Species* s, Scalar np2c0, BOOL vary_np2c = FALSE)
		: ParticleGroup(maxN, s, np2c0, vary_np2c) {}
	void advance(Fields& fields, Scalar dt);
};
#endif	// ifndef __PTCLGPIB_H
