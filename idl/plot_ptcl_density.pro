...
;   z_name:    string to specify the particle species, e.g. "Ne" for 
;              electron's density. 
...
;
; EXAMPLE:
;   plot_ptcl_density, 'ptcl_density_file', 'x', 'y', 'Ne', 2, 1.93e18
;
; MODIFICATION HISTORY:
;   Nov  7, 2000:  original code (DLB)
;   May  1, 2001:  some generalization (DAD)
;   May 10, 2001:  renamed, with many changes (DLB)
;   June 11, 2001: generalized for different scales (DAD)
;   Sep 23, 2003:  minor changes (DLB)
;
;   Version: $Id: plot_ptcl_density.pro 2071 2003-11-07 22:06:15Z bruhwile $
;
;   Copyright (c) 2000-2001 by Tech-X Corporation.  All rights reserved.


pro plot_ptcl_density, base_name, x1Label, x2Label, PtclDensityLabel, ScaleFlag, ScaleInput
...
; *****************************************************************
; Specify minimum values for x1 and x2:
; *****************************************************************
...
;  ez = smooth(ez,3,/EDGE_TRUNCATE)
  ez = smooth(ez,5,/EDGE_TRUNCATE)
;  ez = smooth(ez,9,/EDGE_TRUNCATE)
...
if ( ScaleFlag eq 1 ) then begin
  ...
  z = z/lengthScale
  r = r/lengthScale
  ez=ez/1.e+06/(-1.602e-19)
  q1_label = '!3' + x1Label
  q2_label = '!3' + x2Label
  z_label = '!3' + PtclDensityLabel + ' [cm!u-3!n]'
  ...
  q1_label = '!3' + x1Label
  q2_label = '!3' + x2Label
  z_label = '!3E!D' + PtclDensityLabel + '!N/E!Dp!N'
endif else begin
  ;
...
; Load in the RAINBOW color table
  ...
  contour, -(ez - min(ez)), z, r, thick=2, /xs, /ys, nlevels=40, $
           xtitle=x_label, ytitle=y_label, $
           /fill
;  vpplothist, ez, z, r, /INT
...
;   want to use for the lineout plot
  ...
  density_line = ez(*,r_row)/ScaleInput
...
; Next, save the lineout to an IDL .dat file for later use.
  density_x = z
  save, density_x, density_line, filename = lineout_file

  density_line = density_line * ScaleInput
...
;   or else one that looks OK on the screen (also OK for printing).
  ...
  plot, z, density_line, thick=2, /xs, xtitle=x_label, ytitle=z_label, xrange=[x1min,x1max]
