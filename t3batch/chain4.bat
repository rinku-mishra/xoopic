...
#
# prompt>  cqsub -q production -la premium chain4.bat

# Specify administrative details
#
#QSUB -s /bin/sh          # Specify bash shell
#QSUB -r c4_bat02         # Job name
#QSUB -o chain4.out       # Write NQS output to specified file
#QSUB -e chain4.err       # Write NQS error  to specified file
...
cd $STORE_DIR
cqsub -q production -la premium chain5.bat
