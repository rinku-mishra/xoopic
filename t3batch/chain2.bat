...
#
# prompt>  cqsub -q production -la premium chain2.bat

# Specify administrative details
#
#QSUB -s /bin/sh          # Specify bash shell
#QSUB -r c2_bat02         # Job name
#QSUB -o chain2.out       # Write NQS output to specified file
#QSUB -e chain2.err       # Write NQS error  to specified file
...
cd $STORE_DIR
cqsub -q production -la premium chain3.bat
